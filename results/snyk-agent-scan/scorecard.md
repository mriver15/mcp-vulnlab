# Scorecard: `snyk-agent-scan`

Generated 2026-09-12T14:13:07+00:00 against `/Users/river/Projects/mcp-vulnlab`.

> **This scanner did not run.** The figures below are absent, not zero.
> Reason: every invocation failed; first error: exited with status 1 and produced no stdout

## Summary

| metric | value |
|---|---|
| status | not run — every invocation failed; first error: exited with status 1 and produced no stdout |
...
- control-echo: exited with status 1 and produced no stdout
- control-files: scanner exited with status 1
- control-files: exited with status 1 and produced no stdout
- control-gated-admin: scanner exited with status 1
- control-gated-admin: exited with status 1 and produced no stdout
- exfil-write: scanner exited with status 1
- exfil-write: exited with status 1 and produced no stdout
- injection-echo: scanner exited with status 1
- injection-echo: exited with status 1 and produced no stdout
- no-auth-file: scanner exited with status 1
- no-auth-file: exited with status 1 and produced no stdout
- overbroad-glob: scanner exited with status 1
- overbroad-glob: exited with status 1 and produced no stdout
- pii-leak: scanner exited with status 1
- pii-leak: exited with status 1 and produced no stdout
- supply-chain-yolo: scanner exited with status 1
- supply-chain-yolo: exited with status 1 and produced no stdout
