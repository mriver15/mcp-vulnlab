...
Generated 2026-09-12T13:41:38+00:00 against `/Users/river/Projects/mcp-vulnlab`.

> **This scanner did not run.** The figures below are absent, not zero.
> Reason: command not found: 'skillspector' is not on PATH

## Summary

| metric | value |
|---|---|
| status | not run — command not found: 'skillspector' is not on PATH |
